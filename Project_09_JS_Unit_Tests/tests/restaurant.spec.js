...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const keysReturn = Object.keys(
      createMenu({ food: {}, drink: {} }).fetchMenu
    );

    assert.strictEqual(keysReturn, ["food", "drink"]);
    ...
    const objetoRetornado = createMenu(pastMenu);

    assert.strictEqual(objetoRetornado.fetchMenu, pastMenu);
